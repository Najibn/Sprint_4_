                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="py-3 px-4 border-b">
                                        <div class="flex gap-2">
                                            <a href="{{ route('users.show', $user) }}" class="px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200">
                                                View
                                            </a>
                                            <a href="{{ route('users.edit', $user) }}" class="px-3 py-1 bg-green-100 text-green-800 rounded-md hover:bg-green-200">
                                                Edit
                                            </a>
