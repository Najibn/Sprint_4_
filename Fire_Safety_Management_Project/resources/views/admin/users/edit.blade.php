            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="role" name="role" class="w-full px-4 py-2 mt-2 border rounded-md" required>
                                    ...
                                    <option value="technician" {{ old('role', $user->role) == 'customer' ? 'selected' : '' }}>customer</option>
                                    <option value="customer" {{ old('role', $user->role) == 'technician' ? 'selected' : '' }}>technician</option>
                                </select>
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        ...
                        <a href="{{ route('admin.users.index') }}" class="px-6 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-500">
                            Cancel
                        </a>
                    </div>
                </form>
