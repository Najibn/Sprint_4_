    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="ml-64 flex-grow p-8">
            <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    <form action="{{ route('admin.maintenanceRecords.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="{{ route('admin.maintenanceRecords.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition">
                                Cancel
                            </a>
