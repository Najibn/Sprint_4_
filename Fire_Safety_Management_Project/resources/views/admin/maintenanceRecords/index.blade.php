<x-app-layout>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="fixed top-0 left-0 h-full w-64 bg-indigo-800 text-white shadow-md">
            ...
            <nav class="mt-6">
                <a href="{{ route('admin.dashboard') }}" class="block py-2 px-4 hover:bg-indigo-700 transition duration-200">
                    <i class="fas fa-list mr-2"></i>Dashboard
                </a>
                <a href="{{ route('admin.users.index') }}" class="block py-2 px-4 hover:bg-indigo-700 transition duration-200">
                    <i class="fas fa-users mr-2"></i>Manage Users
                </a>
                <a href="{{ route('admin.products.index') }}" class="block py-2 px-4 hover:bg-indigo-700 transition duration-200">
                    <i class="fas fa-box mr-2"></i>Manage Products
                </a>
                <a href="{{ route('admin.maintenanceRecords.index') }}" class="block py-2 px-4 bg-indigo-900 transition duration-200">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="{{ route('admin.maintenanceRecords.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('admin.maintenanceRecords.show', $maintenanceRecord) }}" class="text-blue-600 hover:text-blue-900 mr-2 transition duration-200">View</a>
                                            <a href="{{ route('admin.maintenanceRecords.edit', $maintenanceRecord) }}" class="text-indigo-600 hover:text-indigo-900 mr-2 transition duration-200">Edit</a>
                                            <form action="{{ route('admin.maintenanceRecords.destroy', $maintenanceRecord) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
