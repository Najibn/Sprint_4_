                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form action="{{ route('maintenanceRecords.update', $maintenanceRecord) }}" method="POST">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="{{ route('maintenanceRecords.index') }}" class="bg-gray-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                        Cancel
                                    </a>
                                </div>
                            </form>
